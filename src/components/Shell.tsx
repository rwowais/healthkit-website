...
// Bottom nav: 5 most important pages with distinct SVG icons
...
// Items only shown in the hamburger menu (not in bottom nav)
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-50 glass border-b border-[#d2d2d7]/60">
        ...
        {/* Mobile Hamburger Menu — shows only Meals & Workout (items not in bottom nav) */}
        {mobileMenuOpen && (
          <nav className="lg:hidden border-t border-[#d2d2d7]/60 px-4 py-3 bg-white">
            {HAMBURGER_ONLY_ITEMS.map((item) => {
              const active = pathname === item.href;
              return (
                <Link
                  key={item.href}
